...
data class WeatherResult(val coord: Coord?, val weather: List<Weather819790300>?, val base: String?, val main: Main?, val visibility: Number?, val wind: Wind?, val rain: Rain?, val clouds: Clouds?, val dt: Number?, val sys: Sys?, val id: Number?, val name: String?, val cod: Number?)
...
data class Rain(val h1h: Number?)

data class Sys(val type: Number?, val id: Number?, val message: Number?, val country: String?, val sunrise: Number?, val sunset: Number?)

data class Weather819790300(val id: Number?, val main: String?, val description: String?, val icon: String?)
